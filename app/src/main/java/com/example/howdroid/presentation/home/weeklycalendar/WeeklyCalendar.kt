...
import com.example.howdroid.presentation.home.weeklycalendar.listener.OnWeeklyCalendarSwipeListener
import com.example.howdroid.presentation.home.weeklycalendar.listener.OnWeeklyDayClickListener
import com.example.howdroid.presentation.home.weeklycalendar.model.TOTAL_COLUMN_COUNT
...
class WeeklyCalendar @JvmOverloads constructor(
    ...
    init {
        ...
        setBackgroundColor(ContextCompat.getColor(context, R.color.Gray_50))
